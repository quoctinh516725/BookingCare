...
function CardService({ service }) {
  ...
  const handleViewDetail = () => {
    ...
    if (id !== undefined && id !== null && id !== '') {
      ...
      console.error("Cannot navigate to service detail: ID is undefined or invalid", service);
      // Improved error message
      alert("Không thể xem chi tiết dịch vụ này. ID dịch vụ không hợp lệ hoặc chưa được tải.");
    }
  };
