...
function CardBlog({ blog }) {
  ...
  const handleViewDetail = () => {
    ...
    if (id !== undefined && id !== null && id !== '') {
      ...
      console.error("Cannot navigate to blog detail: ID is undefined or invalid", blog);
      // Improved error message
      alert("Không thể xem chi tiết bài viết này. ID bài viết không hợp lệ hoặc chưa được tải.");
    }
  };
