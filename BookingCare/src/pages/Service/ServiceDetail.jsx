...
function ServiceDetail() {
  ...
  useEffect(() => {
    ...
    if (!id || id === 'undefined') {
      setError('ID dịch vụ không hợp lệ. Vui lòng chọn một dịch vụ từ danh sách.');
      setLoading(false);
      return;
    }
  ...
  return (
    <div className="container mx-auto py-10 px-4">
      <div className="mb-6">
        <Link to="/service" className="text-blue-500 hover:underline flex items-center">
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="w-full md:w-1/2">
          <img 
            src={service.image || 'https://via.placeholder.com/600x400?text=Dịch+vụ+chăm+sóc+da'} 
            alt={service.name} 
          ...
          <div className="bg-gray-50 p-6 rounded-lg mb-6">
            ...
            <ul className="list-disc pl-5 mb-4">
              {service.benefits ? (
                ...
                <>
                  <li className="text-gray-700 mb-1">Làm sạch sâu lỗ chân lông</li>
                  <li className="text-gray-700 mb-1">Cải thiện độ đàn hồi của da</li>
            ...
            <p className="text-gray-700">
              {service.suitableFor || "Phù hợp với mọi loại da, đặc biệt là da khô và da nhạy cảm"}
            </p>
          </div>
          ...
          {service.process ? (
            ...
            <>
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-700">Làm sạch da mặt với sản phẩm phù hợp với loại da của bạn</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md">
                <div className="w-12 h-12 bg-[var(--primary-color)] rounded-full flex items-center justify-center text-white font-bold text-xl mb-4">
                  2
                ...
                <p className="text-gray-700">Loại bỏ tế bào chết, giúp da sáng mịn và hấp thụ dưỡng chất tốt hơn</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md">
                <div className="w-12 h-12 bg-[var(--primary-color)] rounded-full flex items-center justify-center text-white font-bold text-xl mb-4">
                  3
                ...
                <p className="text-gray-700">Phục hồi độ ẩm và dưỡng chất thiết yếu cho da</p>
              </div>
            </>
          )}
        </div>
