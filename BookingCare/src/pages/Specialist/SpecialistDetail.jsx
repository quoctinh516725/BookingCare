...
function SpecialistDetail() {
    ...
    return (
      <div className="container mx-auto py-10 px-4">
        <div className="text-center">
          ...
          <Link to="/specialist" className="text-blue-500 hover:underline">
  ...
  return (
    <div className="container mx-auto py-10 px-4">
      <div className="mb-6">
        <Link to="/specialist" className="text-blue-500 hover:underline flex items-center">
          <i className="fa fa-arrow-left mr-2"></i> Quay lại danh sách chuyên gia
        </Link>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="w-full md:w-1/3">
          <div className="bg-white rounded-lg shadow-md p-6 text-center">
            <img 
              src={specialist.image || 'https://via.placeholder.com/300x300?text=Specialist'} 
              alt={fullName} 
              className="w-40 h-40 rounded-full mx-auto mb-4 object-cover"
            />
            <h1 className="text-2xl font-bold mb-2">{fullName}</h1>
            <p className="text-[var(--primary-color)] font-semibold mb-4">{specialist.expertise || 'Chuyên gia chăm sóc da'}</p>
            
            <div className="flex items-center justify-center text-gray-600 mb-4">
              <i className="fa-solid fa-graduation-cap mr-2"></i>
              <span>{specialist.qualification || 'Chứng chỉ chăm sóc da quốc tế'}</span>
            </div>
            ...
            {specialist.reviews && specialist.reviews.length > 0 ? (
              ...
              <>
                <div className="border-b pb-4 mb-4">
                  ...
                  <p className="text-gray-700">Tôi rất hài lòng với dịch vụ của chuyên gia. Làn da của tôi đã được cải thiện rõ rệt sau khi điều trị.</p>
                </div>
                ...
                <div className="border-b pb-4 mb-4">
                  ...
                  <p className="text-gray-700">Chuyên gia rất tận tình và chuyên nghiệp. Tôi đã được tư vấn chi tiết về cách chăm sóc da phù hợp với làn da của mình.</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-700">Dịch vụ tuyệt vời! Chuyên gia có kiến thức sâu rộng về chăm sóc da và luôn đưa ra những lời khuyên hữu ích.</p>
                </div>
              </>
            )}
          </div>
