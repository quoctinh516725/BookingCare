    ...
    <div className="min-h-screen bg-gray-50">
      <div className=" mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-sm overflow-hidden">
          ...
          <div className="p-5">
            <h2 className="text-lg font-medium text-gray-800 mb-4">Danh sách chuyên viên</h2>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {specialists.map((specialist) => (
                    <tr key={specialist.id} className="hover:bg-gray-50">
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          <div className="flex-shrink-0 h-10 w-10">
                            <img className="h-10 w-10 rounded-full" src={specialist.avatar} alt="" />
                          </div>
                          <div className="ml-4">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-900">{specialist.specialty}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-900">{specialist.email}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-900">{specialist.phone}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-900">{specialist.experience}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        {renderStars(specialist.rating)}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${specialist.status === 'Đang làm việc' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'}`}>
                          {specialist.status}
                        </span>
                      </td>
